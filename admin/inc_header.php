...
<head>
    ...
    <title>Admin Kecamatan Penjaringan</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="halaman.php">Berita</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="tutors.php">Anggota</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="partners.php">Visi & Misi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="info.php">Contact</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="members.php"></a>
                        </li>
                        <li class="nav-item">
