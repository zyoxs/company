...
function kirim_email($email_penerima, $nama_penerima,$judul_email,$isi_email){
    ...
    $email_pengirim     = "rivaldi.faluhi111@gmai.com";
    $nama_pengirim      = "norepaly";
    ...
    try {
        ...
        $mail->Host       = 'smtp.gmail.com'; // Correct spelling                     //Set the SMTP server to send through
